...
This program is for studing the 'Compiled' AutoIt3 format.
...
Double click on the log window to enlarge it and for copy text from it like for example the offset. 

*New* Limited Support for AutoIT v3.2.6++ Taht uses finally uses 'Tokens'
...
'Jos van der Zande AutoIt3 Source Obfuscator v1.0.20 [Sept  8, 2007]' and
'EncodeIt 2.0'
...
'Force Old Script Type'
	Grey means autodetect and is the best im most cases. However if autodetection fail
	or is fooled through modification try to enable/disable this setting
	
'Don't delete temp file (compressed script)'	
	this will keep *.EA05 files you may try to unpack manually with'LZSS.exe'
	Also check this to get verbose information when decompile(DeToken) new 3.2.5+ compiled Exe
...
'Restore Includes'
	will seperated/restore includes.
...
'Use 'normal' Au3_Signature to find start of script'
	Will uses the normal 16-byte startsignature to detect the start of a script
	often this signature was modified or is used for a fake script that is
	just attached to distract & misslead a decompiler.
	When off it scans for the 'FILE' as encrypted text to find the start of a script
	Default:OFF

'Lookup Passwordhash'
	Copies current passwordhash to clipboard and launches	
	http://md5cracker.de
	...
	Ah yes to open a file you may also pass it via commandline like this
	"myAutToExe.exe C:\Program Files\Example.exe" -> "myAutToExe.exe %1"
	So you may associate exe file with myAutToExe.exe to decompile them with a rightclick.
	When create the association space don't matters but don't use "C:\Program F.." as you normally need to do when there's space in pathname
	

Files (sorted by importance): 
 myAutToExe.exe     Compiled (pCode) VB6-Exe
 mt.dll     		Mersenne Twister pRandom Generator - used to decrypt scriptdata
 LZSS.exe   		Called after to decryption to decompress the script
 Tidy\      		runned after deobfucating to apply indent to the sourcecode
 src_AutToExe_VBA.doc   VBA Version - use this for debugging if you don't have VB6 installed
 samples\   		Usefull 'protected' example scripts; use myExe2Aut to reveal its the sources
 src\       		VB6 source code
 Au3-Extracter Script 0.2\	AutoIt Script to decompile a *.au3-exe or *.a3x
 Src_mt.dll\ 		C source code for mt.dll
 Src_lzss\ 			C++ source code for lzss.exe
...
The Compiled Script AutoIt Fileformat:
--------------------------------------
...
Version 3_2
	...
	search entired script for AutoITSignature to reach start of script
...
1.71 Bug fix: outputname contained '>' that result in an invalid output filename

1.7 Bug fixes and improvement in 'Includes seperator module'
    Added support for old (EA04) AutoItScripts
    
1.6 Added: Includes seperator module

1.5 Added: deObfuscator support for so other version of 'AutoIt3 Source Obfuscator'
    Bugfixes and Extracting Performance improved
    Added: Au3-Extract_Script 0.2.au3

1.4 Added: deObfuscator Module for older version of 'AutoIt3 Source Obfuscator'

1.3 Added: FileExtractor Module
...
<cw2k@gmx.de>           http://maghia.free.fr/Board/viewtopic.php?t=234
...
4.----------------------------------------------------
Now you can feed that dump file into the decompiler.myExe2Aut - The Open Source Autoit Script Decompiler
====================================================
...
00D00074  45004200  .B.E
4.----------------------------------------------------
Now you can feed that dump file into tmyExe2Aut - The Open Source Autoit Script Decompiler
====================================================
...
00D00074  45004200  .B.E
4.----------------------------------------------------
Now you camyExe2Aut - The Open Source Autoit Script Decompiler
====================================================
...
00D00070  4E004700  .G.N
00D00074  45004200  .B.E
4.--------myExe2Aut - The Open Source Autoit Script Decompiler
====================================================
...
00D00060  64006800  .h.d
00D00064  7F006500  .e.
00myExe2Aut - The Open Source Autoit Script Decompiler
====================================================
